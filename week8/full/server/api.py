...
from server.metrics import LATENCY, REDIS_HITS, REDIS_MISS, REQUESTS
...
class RecommendationsResponse(BaseModel):
    ...
    payload: list[int] = Field(default=[], description="List of recommendations for user.")
...
def recommendations(
    ...
    if recs is None:
        ...
        return RecommendationsResponse(status="error", message="triton failed to process request")
